...
# Look at block_type argument to get an idea on how to easily pass module names as an argument
# We are asked to run an experiment with a diff learning rate; the parser can come in handy for this
def get_args():
    """
